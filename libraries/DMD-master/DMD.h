...
#define PIN_DMD_nOE       15    // D9 active low Output Enable, setting this low lights all the LEDs in the selected rows. Can pwm it at very high frequency for brightness control.
#define PIN_DMD_A         16    // D6
#define PIN_DMD_B         12    // D7
#define PIN_DMD_CLK       14   // D13_SCK  is SPI Clock if SPI is used
#define PIN_DMD_SCLK      0   // D8
#define PIN_DMD_R_DATA    13   // D11_MOSI is SPI Master Out if SPI is used
